...
ms.locfileid: "115996095"
---
# <a name="manage-customers"></a>Hantera kunder

**Gäller för**: Partner Center-| Partnercenter som drivs av 21Vianet | PartnerCenter för Microsoft Cloud Germany | Partnercenter för Microsoft Cloud for US Government

I det här avsnittet beskrivs hur Molnlösningsleverantör kan använda Partnercenter för att hantera kundkonton programmatiskt.

## <a name="create-a-customer"></a>Skapa en kund

- [Begära en återförsäljarrelation](request-reseller-relationship.md)
...
- [Skaffa en kund efter företagsnamn eller domän](get-a-customer-by-name.md)
- [Hämta en lista över kunder](get-a-list-of-customers.md)

## <a name="manage-customer-orders-and-subscriptions"></a>Hantera kundorder och prenumerationer
...
- [Hämta alla en kunds prenumerationer](get-all-of-a-customer-s-subscriptions.md)
- [Uppdatera smeknamnet för en prenumeration](update-the-nickname-for-a-subscription.md)

## <a name="manage-customer-account-details"></a>Hantera kundkontoinformation
...
- [Uppdatera en kunds utgiftsbudget för användning](update-a-customer-s-usage-spending-budget.md)
...
- [Få bekräftelse på kundens godkännande av Microsoft Cloud-avtalet](get-confirmation-of-customer-consent.md)
...
- [Ta bort användarkonton för en kund](delete-user-accounts-for-a-customer.md)
...
- [Kontrollera vilka licenser som är tilldelade till en användare](check-which-licenses-are-assigned-to-a-user.md)

## <a name="manage-a-customers-self-serve-policies"></a>Hantera en kunds självbetjäningsprinciper
