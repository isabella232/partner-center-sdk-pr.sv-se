...
ms.locfileid: "115992916"
---
# <a name="get-usage-records-for-all-customers"></a>Hämta användningsposter för alla kunder

**Gäller för:** Partner Center-| Partnercenter för Microsoft Cloud Germany | Partnercenter för Microsoft Cloud for US Government

Partner kan använda **resurssamlingen CustomerMonthlyUsageRecord** för att hämta användningsposter för alla sina kunder. Den här resursen representerar användningsposter för alla kunder. Det omfattar de kunder som har en Microsoft Azure-prenumeration (MS-AZR-0145P) eller en Azure-plan.
...
Så här hämtar du alla användningsposter för alla kunder som har köpt en specifik Azure-tjänst eller -resurs under den aktuella faktureringsperioden:

1. Använd din **IAggregatePartner.Customers-samling** för att anropa **metoden ById().**

2. Anropa **egenskapen UsageRecords** och anropa sedan **metoden Get()** eller **GetAsync().**
...
|---------|-------------------------------------------------------------------------------|
| **Få** | [*{baseURL}*](partner-center-rest-urls.md)/v1/customers/usagerecords HTTP/1.1 |
...
Om det lyckas returnerar den här **metoden en CustomerMonthlyUsageRecord-resurs** i svarstexten.
